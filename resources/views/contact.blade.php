...
@section('title', 'Contact Us - Travelia')
...
<section class="tt-page-hero">
	...
	<div class="container" data-aos="fade-up">
		...
		<p class="tt-page-subtitle">Ready to explore the world's wonders? We're here to help you plan the perfect adventure.</p>
	</div>
</section>
		...
		<div class="row g-4" data-aos="fade-up">
			<div class="col-md-6 col-lg-3">
				<div class="tt-contact-card text-center">
					...
					<p>123 Travel Street<br>City Center</p>
				</div>
			</div>
			<div class="col-md-6 col-lg-3">
				<div class="tt-contact-card text-center">
					...
					<p>
						...
						<a href="https://wa.me/1234567890" target="_blank" class="ms-2 text-success" title="Chat on WhatsApp" id="whatsapp-contact-link" style="font-size: 1.20rem; vertical-align: middle;">
			...
			<div class="col-md-6 col-lg-3">
				<div class="tt-contact-card text-center">
					...
					<h5>Email Us</h5>
					<p><a href="mailto:info@travelia.com">info@travelia.com</a><br>We reply within 24 hours</p>
				</div>
			</div>
			<div class="col-md-6 col-lg-3">
				<div class="tt-contact-card text-center">
					...
					<h5>Live Chat</h5>
					<p>
						<a href="https://wa.me/1234567890" target="_blank" class="btn-tt-outline btn-sm py-1 px-3 mt-1 d-inline-flex align-items-center gap-2" style="border-radius: 8px; font-size: 0.85rem; text-decoration: none;">
							<i class="fab fa-whatsapp"></i> Chat Now
						</a>
						<br>Available Mon - Fri: 9AM - 5PM
					</p>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-8">
				<div class="accordion tt-accordion" id="faqAccordion" data-aos="fade-up">
					<div class="accordion-item">
						<h2 class="accordion-header"><button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faq1">How far in advance should I book my trip?</button></h2>
					...
					<div class="accordion-item">
						<h2 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq2">What is included in the tour packages?</button></h2>
						<div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
							<div class="accordion-body">Our packages typically include accommodation, meals, professional guide, and airport transfers. Specific inclusions vary by package.</div>
						</div>
					</div>
					<div class="accordion-item">
						...
						<div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
							<div class="accordion-body">Absolutely! We specialize in tailor-made experiences. Contact us with your preferences, budget, and travel dates, and we'll craft the perfect adventure.</div>
						</div>
					</div>
					<div class="accordion-item">
						...
						<div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
							<div class="accordion-body">We accept bank transfers, credit/debit cards via Stripe, and international wire transfers. A deposit is typically required to confirm your booking.</div>
						</div>
					</div>
				</div>
			</div>
...
function initMap() {
	...
	const map = new google.maps.Map(document.getElementById('map'), { zoom: 4, center: loc });
	const marker = new google.maps.Marker({ position: loc, map, title: 'Travelia', animation: google.maps.Animation.DROP });
	const info = new google.maps.InfoWindow({ content: '<div style="padding:.75rem"><strong>Travelia</strong><br>123 Travel Street<br><span style="color:var(--tt-primary)">+1 234 567 890</span></div>' });
