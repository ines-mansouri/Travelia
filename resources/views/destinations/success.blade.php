...
@section('title', $booking->status === 'paid' ? 'Booking Confirmed - Travelia' : 'Booking Details - Travelia')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center" data-aos="zoom-in">
                <div style="font-size:5rem;color:#198754;animation:popIn 0.6s cubic-bezier(0.68,-0.55,0.27,1.55);">
                    <i class="fas fa-check-circle"></i>
                </div>
                <h1 class="display-5 fw-bold mt-3" style="font-family:var(--tt-font-display);">
                    @if($isPaid) Booking Confirmed! @else Booking Received @endif
                </h1>
            ...
            <div class="col-lg-8" data-aos="fade-up">
                <div class="tt-sidebar-card">
                    <div class="d-flex align-items-center gap-3 mb-4">
                        ...
                        <div>
                            <h5 class="mb-0">{{ $dest->title ?? 'Destination' }}</h5>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            ...
                            <span class="badge bg-{{ $isPaid ? 'success' : 'warning' }}" style="font-size:0.85rem;">
                                {{ $isPaid ? 'Paid' : 'Pending' }}
                            </span>
                        </div>
                    </div>
                    ...
                    {{-- Price --}}
                    @if($booking->currency_code)
                    <hr class="my-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <span class="fw-semibold">Amount Charged</span>
                            <small class="text-muted d-block">({{ $booking->currency_code }})</small>
                        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-1">
                        <small class="text-muted">Original (USD)</small>
                        <small class="text-muted" style="text-decoration:line-through;">${{ number_format($booking->original_price_usd, 2) }}</small>
                    </div>
                    @endif
                </div>
            </div>
