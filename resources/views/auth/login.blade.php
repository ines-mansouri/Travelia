...
@section('title', 'Sign In - Travelia')

@section('page')
<div class="tt-auth-bg">
    <div class="tt-auth-card" data-aos="fade-up">
        <!-- Brand -->
        <img src="{{ asset('images/logo.png') }}" alt="Travelia" style="height:60px;width:auto;margin:0 auto 0.75rem;display:block;">
        <h2>Welcome Back</h2>
        ...
        <form method="POST" action="{{ route('login') }}" class="tt-form">
            ...
            <div class="text-center my-3">
                <small class="text-muted">New to Travelia?</small>
            </div>
        ...
        <div class="text-center mt-4">
            <small class="text-muted">&copy; {{ date('Y') }} Travelia. Experience the world differently.</small>
        </div>
    </div>
</div>
@endsection